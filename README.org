...
| arrow keys       | move selection or floating paste 1 grid unit                                    |
| shift + arrows   | move floating paste 10 grid units; or move active layer only (live selection)   |
| alt + arrows     | move live selection 10 grid units                                               |
| drag inside selection | drag-to-move selected points (all layers; hold shift = active layer only) |
